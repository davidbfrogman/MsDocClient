export const TranslationsDataENUS = {
   ...
   'History': 'History',
   'ErrorApiRetrieveItem':
    'The document could not be retrieved. Make sure that it is not deleted and that you are allowed to view the document.',
   'Print': 'Print',
   ...
   'ErrorApiListTemplates':
    'The templates could not be listed for the specified document type. Make sure that the document type supports templates.',
   'ErrorApiCheckOutItem':
    'The document could not be checked out. Make sure that it is checked in and that you are allowed to check out the document.',
   'CheckOut': 'Check Out',
   'MIMEType': 'MIME Type',
   ...
   'Open': 'Open',
   'ErrorApiRevertVersion':
    'The document version could not be reverted. Make sure that it is not deleted and that you are allowed to edit the document.',
   ...
   'ChangesInCCMessage':
    'Changes have been made in Control Center. \
     For these to be visible you need to reload the IDM client. If you reload the client all unsaved changes will be lost.',
   'OperationLike': 'Like',
   'MenuThumbnails': 'Thumbnails',
   'DiscardCheckoutMultipleDocsQuestion':
    'One or more of the selected documents are checked out. \
    All changes made to the checked out documents are going to be discarded. Do you want to proceed?',
   ...
   'Version': 'Version',
   'Search': 'Search',
   'ErrorApiCreateFromTemplate':
     'The document could not be created from the template. \
     Make sure that all attributes are correct and that you are allowed to view the template.',
   'Failed': 'Failed',
   'Discard': 'Discard',
   ...
   'MenuDetails': 'Details',
   'ErrorApiUpdateItem': 'The document could not be updated. \
    Make sure that all attributes are correct and that the document is not checked out by someone else.',
   ...
   'MenuItemClose': 'Close',
   'All': 'All',
   'ForceCheckInQuestion':
    'The current document is checked out by another user but will be forced checked in if you have the necessary privileges.',
   ...
   'ErrorApiRetrieveFile':
    'The document file could not be retrieved. Make sure that it is not deleted and that you are allowed to view the document.',
   ...
   'ErrorApiRetrieveVersions':
    'The versions of the document could not be retrieved. Make sure that the document is not deleted and that you are allowed to view it.',
   'OperationLessEqual': 'Less than or equal',
   'ErrorApiCopyItem':
    'The document could not be copied. Make sure that all attributes are correct and that you are allowed to view the document.'
};
