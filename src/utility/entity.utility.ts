...
export class EntityUtility {
    ...
    public static BuildDefaultAttributes(entity: Entity): Entity {
        if (!entity.isDefaultAttrBuilt) {
            ...
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.CREATED_BY, 'CreatedBy', 'CREATEUSERID', true, AttributeType.String,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.CREATED_TIMESTAMP, 'CreatedTS', 'CREATETS', false, AttributeType.Timestamp,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.CHECKED_OUT_BY, 'CheckedOutBy', 'CHECKEDOUTUSERID', true, AttributeType.String,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.CHECKED_OUT_TIMESTAMP, 'checkedOutTS', 'CHECKEDOUTTS', false, AttributeType.Timestamp,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.LAST_CHANGED_BY, 'ModifiedBy', 'LASTCHANGEDUSERID', true, AttributeType.String,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.LAST_CHANGED_TIMESTAMP, 'ModifiedTS', 'LASTCHANGEDTS', false, AttributeType.Timestamp,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.SIZE, 'RESOURCESIZE', 'RESOURCESIZE', false, AttributeType.Long,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.DISPLAYNAME, 'displayName', 'displayName', false, AttributeType.String,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.FILE_NAME, 'RESOURCENAME', 'RESOURCENAME', false, AttributeType.String,false));
            entity.defaultAttributes.push(AttributeUtility.buildDefaultAttribute(TranslationConstants.INTERNAL_ID, 'ITEMID', 'ITEMID', false, AttributeType.String,false));
